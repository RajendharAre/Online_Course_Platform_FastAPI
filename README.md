...
LearnHub is a complete backend solution built with FastAPI that handles the entire lifecycle of an online course platform - from course discovery and filtering to enrollment processing and wishlist management.
...
1. **Complete Python Bootcamp** - Web Development, Beginner, ₹4999
2. **Machine Learning A-Z** - Data Science, Intermediate, ₹7999
3. **UI/UX Design Masterclass** - Design, Beginner, ₹3999 (Sold Out)
4. **Docker & Kubernetes** - DevOps, Advanced, ₹6499
5. **React - The Complete Guide** - Web Development, Intermediate, ₹5999
6. **Free Introduction to Programming** - Web Development, Beginner, Free

Categories represented: Web Development (3), Data Science (1), Design (1), DevOps (1)
